...
describe('directory traversal', () => {
	describe('1 level deep', () => {
		...
		describe('peer file with [PARENT_PATH] "../"', () => {
			...
			it('has [LOAD_PATH] set to file path', () => {
				expect(route[LOAD_PATH]).toBe(pathJoin(fixturePath, 'sub', 'onParent.js'));
			});
	...
	describe('2 levels deep', () => {
		...
		describe('2nd level index file', () => {
			...
			it('has [LOAD_PATH] set to file path', () => {
				expect(route[LOAD_PATH]).toBe(pathJoin(fixturePath, 'sub', 'subSub', 'index.js'));
			});
		...
		describe('2nd level peer file with [PARENT_PATH] "../../"', () => {
			...
			it('has [LOAD_PATH] set to file path', () => {
				expect(route[LOAD_PATH]).toBe(pathJoin(fixturePath, 'sub', 'subSub', 'onParentParent.js'));
			});
	...
	describe('directory index on parent peer', () => {
		...
		describe('peer file', () => {
			...
			it('has [LOAD_DIR_PATH] set to dir path', () => {
				expect(route[LOAD_DIR_PATH]).toBe(fixturePath, 'sub');
			});
		});
		...
		describe('peer of directory index', () => {
			...
			it('has [LOAD_PATH] set to file path', () => {
				expect(route[LOAD_PATH]).toBe(pathJoin(fixturePath, 'sub', 'view.js'));
			});
	...
	describe('directory peer on parent peer', () => {
		...
		describe('peer of directory index', () => {
			...
			it('has [LOAD_PATH] set to file path', () => {
				expect(route[LOAD_PATH]).toBe(pathJoin(fixturePath, 'sub', 'onParentPeer.js'));
			});
